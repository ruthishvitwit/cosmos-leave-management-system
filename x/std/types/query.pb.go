...
var fileDescriptor_9a98e274c07d07a4 = []byte{
	...
	0xcd, 0x2f, 0xd6, 0x2f, 0x2e, 0x49, 0xd1, 0x2f, 0x33, 0x4c, 0x4a, 0x2d, 0x49, 0x34, 0xd4, 0x2f,
	0x2c, 0x4d, 0x2d, 0xaa, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x82, 0xc8, 0xeb, 0x15,
	0x97, 0xa4, 0xe8, 0x41, 0xe5, 0xa5, 0xa4, 0xb1, 0xe8, 0x29, 0xa9, 0x80, 0x68, 0x50, 0x12, 0xe1,
	...
	0x4b, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x74, 0x59, 0x5c, 0xd4, 0x65, 0x03, 0x00, 0x00,
}
...
func (c *queryClient) GetStudents(ctx context.Context, in *GetStudentsRequest, opts ...grpc.CallOption) (*GetStudentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.std.v1beta1.Query/GetStudents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetLeaveRequests(ctx context.Context, in *GetLeaveRequestsRequest, opts ...grpc.CallOption) (*GetLeaveRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.std.v1beta1.Query/GetLeaveRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetLeaveApprovedRequests(ctx context.Context, in *GetLeaveApprovedRequestsRequest, opts ...grpc.CallOption) (*GetLeaveApprovedRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.std.v1beta1.Query/GetLeaveApprovedRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetStudents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.std.v1beta1.Query/GetStudents",
	}
...
func _Query_GetLeaveRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.std.v1beta1.Query/GetLeaveRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetLeaveApprovedRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.std.v1beta1.Query/GetLeaveApprovedRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
